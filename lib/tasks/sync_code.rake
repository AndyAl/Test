...
task :sync_code => [:clean_named_screenshots,:spec, :karma] do # TODO: Add teaspoon when we get there
  ...
  puts `rsync --exclude .git --exclude tmp --exclude node_modules --exclude log --exclude spec/screenshots -av . #{code_branch_dir}`
